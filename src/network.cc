...
Network<Gang1Type, Gang2Type>::Network( const typename Gang1Type::Sender & example_sender1,
  ...
  : _prng( s_prng ),
    _senders( Gang1Type( config.mean_on_duration, config.mean_off_duration, config.num_senders, config.utility_penalty, example_sender1, _prng ),
	      Gang2Type( config.mean_on_duration, config.mean_off_duration, config.num_senders, config.utility_penalty, example_sender2, _prng, config.num_senders ) ),
